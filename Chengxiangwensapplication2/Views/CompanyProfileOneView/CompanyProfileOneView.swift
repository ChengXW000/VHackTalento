...
struct CompanyProfileOneView: View {
    @StateObject var companyProfileOneViewModel = CompanyProfileOneViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    ZStack(alignment: .topLeading) {
                        ...
                        VStack {
                            ...
                            Text(StringConstants.kMsgFusionexIsAG)
                    ...
                    ZStack(alignment: .leading) {
                        ...
                        ZStack(alignment: .topTrailing) {
                            ...
                            VStack(alignment: .leading, spacing: 0) {
                                VStack {
                                    Text(StringConstants.kLbl88kSaves)
                                        .font(FontScheme
                                    ...
                                    Divider()
                                        ...
                                        .padding(.horizontal, getRelativeWidth(28.0))
                                    Text(StringConstants.kLbl99kFollowers)
                                        .font(FontScheme
                                            .kRobotoRomanBold(size: getRelativeHeight(18.0)))
                                        .fontWeight(.bold)
                                        .foregroundColor(ColorConstants.Black900)
                ...
                Group {
                    NavigationLink(destination: VHackHomeCompaPageTwoView(),
                                   ...
                                   selection: $companyProfileOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct CompanyProfileOneView_Previews: PreviewProvider {
    static var previews: some View {
        CompanyProfileOneView()
    }
}
