...
struct VHackHomeCompaPageOneView: View {
    @StateObject var vHackHomeCompaPageOneViewModel = VHackHomeCompaPageOneViewModel()
    @Environment(\.presentationMode) var presentationMode: Binding<PresentationMode>
    var body: some View {
        NavigationView {
            VStack {
                ZStack(alignment: .leading) {
                    Image("img_background_852x414")
                        .resizable()
                    ...
                    VStack(alignment: .trailing, spacing: 0) {
                        HStack {
                            HStack {
                                Text(StringConstants.kLblCandidates)
                                    ...
                                    .onTapGesture {
                                        vHackHomeCompaPageOneViewModel
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            Image("img_image18")
                                ...
                                .onTapGesture {
                                    vHackHomeCompaPageOneViewModel
                                        .nextScreen = "CompanyDescriptionOneView"
                                }
                            HStack {
                                VStack(alignment: .leading, spacing: 0) {
                                    Text(StringConstants.kMsgFusionexgroup)
                                        .font(FontScheme
                        ...
                        .frame(width: getRelativeWidth(397.0), height: getRelativeHeight(430.0),
                               alignment: .center)
                ...
                Group {
                    NavigationLink(destination: VHackHomeCandiPageOneView(),
                                   ...
                                   selection: $vHackHomeCompaPageOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                    NavigationLink(destination: CompanyDescriptionOneView(),
                                   tag: "CompanyDescriptionOneView",
                                   selection: $vHackHomeCompaPageOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct VHackHomeCompaPageOneView_Previews: PreviewProvider {
    static var previews: some View {
        VHackHomeCompaPageOneView()
    }
}
