...
struct CompanyApply3View: View {
    @StateObject var companyApply3ViewModel = CompanyApply3ViewModel()
            ...
            VStack {
                HStack {
                    Text(StringConstants.kMsgFreshGraduate)
                        ...
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(211.0), height: getRelativeHeight(15.0),
                               alignment: .topLeading)
                    Image("img_closeicon_gray_901")
                        .resizable()
                        .frame(width: getRelativeWidth(9.0), height: getRelativeWidth(9.0),
                ...
                .frame(width: getRelativeWidth(293.0), height: getRelativeHeight(15.0),
                       alignment: .trailing)
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    Text(StringConstants.kMsgABachelorSDe)
                ...
                VStack(alignment: .leading, spacing: 0) {
                    Text(StringConstants.kLblJobScope)
                        ...
                        .padding(.horizontal, getRelativeWidth(14.0))
                    Text(StringConstants.kMsgCarryOutTheD)
                        .font(FontScheme.kRobotoBlack(size: getRelativeHeight(11.0)))
                        .fontWeight(.black)
                        .foregroundColor(ColorConstants.Bluegray400)
                        .minimumScaleFactor(0.5)
                ...
                .frame(width: getRelativeWidth(384.0), height: getRelativeHeight(70.0),
                       alignment: .center)
                .background(RoundedCorners(topLeft: 8.0, topRight: 8.0, bottomLeft: 8.0,
                                           bottomRight: 8.0)
                        .fill(ColorConstants.Gray50))
                ...
                VStack {
                    Text(StringConstants.kLblLookingFor)
                        ...
                        .padding(.top, getRelativeHeight(12.0))
                        .padding(.horizontal, getRelativeWidth(14.0))
                    Text(StringConstants.kMsgCandidatesWith2)
                        .font(FontScheme.kRobotoBlack(size: getRelativeHeight(11.0)))
                        .fontWeight(.black)
                        .foregroundColor(ColorConstants.Bluegray400)
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(348.0), height: getRelativeHeight(116.0),
                               alignment: .topLeading)
                        .padding(.vertical, getRelativeHeight(4.0))
                        .padding(.horizontal, getRelativeWidth(14.0))
                }
                .frame(width: getRelativeWidth(384.0), height: getRelativeHeight(173.0),
                       alignment: .center)
                .background(RoundedCorners(topLeft: 8.0, topRight: 8.0, bottomLeft: 8.0,
                                           bottomRight: 8.0)
                        .fill(ColorConstants.Gray50))
                ...
                VStack {
                    Text(StringConstants.kLblBenefits)
                        ...
                        .padding(.horizontal, getRelativeWidth(14.0))
                    Text(StringConstants.kMsgShowUsWhatYo)
                        .font(FontScheme.kRobotoBlack(size: getRelativeHeight(11.0)))
                        .fontWeight(.black)
                        .foregroundColor(ColorConstants.Bluegray400)
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(348.0), height: getRelativeHeight(65.0),
                               alignment: .topLeading)
                        .padding(.top, getRelativeHeight(11.0))
                        .padding(.bottom, getRelativeHeight(10.0))
                        .padding(.horizontal, getRelativeWidth(14.0))
                }
                .frame(width: getRelativeWidth(384.0), height: getRelativeHeight(114.0),
                       alignment: .center)
                .background(RoundedCorners(topLeft: 8.0, topRight: 8.0, bottomLeft: 8.0,
                                           bottomRight: 8.0)
                        .fill(ColorConstants.Gray50))
...
struct CompanyApply3View_Previews: PreviewProvider {
