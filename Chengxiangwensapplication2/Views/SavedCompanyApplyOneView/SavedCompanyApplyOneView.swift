...
struct SavedCompanyApplyOneView: View {
    @StateObject var savedCompanyApplyOneViewModel = SavedCompanyApplyOneViewModel()
        ...
        ZStack(alignment: .leading) {
            ...
            VStack {
                HStack {
                    ...
                    .frame(width: getRelativeWidth(294.0), height: getRelativeHeight(15.0),
                           alignment: .leading)
                }
                .frame(width: getRelativeWidth(294.0), height: getRelativeHeight(15.0),
                       alignment: .leading)
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    Text(StringConstants.kMsgTertiaryEducat)
                ...
                VStack(alignment: .leading, spacing: 0) {
                    Text(StringConstants.kLblJobScope)
                        ...
                        .padding(.horizontal, getRelativeWidth(14.0))
                    Text(StringConstants.kMsgAbilityToPerf)
                        .font(FontScheme.kRobotoBlack(size: getRelativeHeight(11.0)))
                        .fontWeight(.black)
                        .foregroundColor(ColorConstants.Bluegray400)
                        .minimumScaleFactor(0.5)
                ...
                .frame(width: getRelativeWidth(384.0), height: getRelativeHeight(74.0),
                       alignment: .center)
                .background(RoundedCorners(topLeft: 8.0, topRight: 8.0, bottomLeft: 8.0,
                                           bottomRight: 8.0)
                        .fill(ColorConstants.Gray50))
                ...
                VStack {
                    Text(StringConstants.kLblLookingFor)
                        ...
                        .padding(.horizontal, getRelativeWidth(14.0))
                    Text(StringConstants.kMsgCandidatesWith3)
                        .font(FontScheme.kRobotoBlack(size: getRelativeHeight(11.0)))
                        .fontWeight(.black)
                        .foregroundColor(ColorConstants.Bluegray400)
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(348.0), height: getRelativeHeight(64.0),
                               alignment: .topLeading)
                        .padding(.vertical, getRelativeHeight(4.0))
                        .padding(.horizontal, getRelativeWidth(14.0))
                }
                .frame(width: getRelativeWidth(384.0), height: getRelativeHeight(113.0),
                       alignment: .center)
                .background(RoundedCorners(topLeft: 8.0, topRight: 8.0, bottomLeft: 8.0,
                                           bottomRight: 8.0)
                        .fill(ColorConstants.Gray50))
                ...
                VStack {
                    Text(StringConstants.kLblPrefer)
                        ...
                        .padding(.horizontal, getRelativeWidth(14.0))
                    Text(StringConstants.kMsgPreviousExperi)
                        .font(FontScheme.kRobotoBlack(size: getRelativeHeight(11.0)))
                        .fontWeight(.black)
                        .foregroundColor(ColorConstants.Bluegray400)
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(348.0), height: getRelativeHeight(128.0),
                               alignment: .topLeading)
                        .padding(.vertical, getRelativeHeight(11.0))
                        .padding(.horizontal, getRelativeWidth(14.0))
                }
                .frame(width: getRelativeWidth(384.0), height: getRelativeHeight(178.0),
                       alignment: .center)
                .background(RoundedCorners(topLeft: 8.0, topRight: 8.0, bottomLeft: 8.0,
                                           bottomRight: 8.0)
                        .fill(ColorConstants.Gray50))
...
struct SavedCompanyApplyOneView_Previews: PreviewProvider {
    static var previews: some View {
        SavedCompanyApplyOneView()
    }
}
