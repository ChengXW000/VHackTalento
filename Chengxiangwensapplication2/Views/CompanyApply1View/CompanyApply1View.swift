...
struct CompanyApply1View: View {
    @StateObject var companyApply1ViewModel = CompanyApply1ViewModel()
            ...
            VStack {
                HStack {
                    Text(StringConstants.kMsgInternWebDe)
                        ...
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(154.0), height: getRelativeHeight(15.0),
                               alignment: .topLeading)
                    Image("img_closeicon_gray_901")
                        .resizable()
                        .frame(width: getRelativeWidth(9.0), height: getRelativeWidth(9.0),
                ...
                .frame(width: getRelativeWidth(265.0), height: getRelativeHeight(15.0),
                       alignment: .trailing)
                ...
                VStack(alignment: .leading, spacing: 0) {
                    Text(StringConstants.kLblJobScope)
                        ...
                        .padding(.horizontal, getRelativeWidth(14.0))
                    Text(StringConstants.kMsgInvolvedInDes)
                        .font(FontScheme.kRobotoBlack(size: getRelativeHeight(11.0)))
                        .fontWeight(.black)
                        .foregroundColor(ColorConstants.Bluegray400)
                        .minimumScaleFactor(0.5)
                ...
                VStack {
                    Text(StringConstants.kLblLookingFor)
                        ...
                        .padding(.top, getRelativeHeight(12.0))
                        .padding(.horizontal, getRelativeWidth(14.0))
                    Text(StringConstants.kMsgCandidateFamil)
                        .font(FontScheme.kRobotoBlack(size: getRelativeHeight(11.0)))
                        .fontWeight(.black)
                        .foregroundColor(ColorConstants.Bluegray400)
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(348.0), height: getRelativeHeight(77.0),
                               alignment: .topLeading)
                        .padding(.vertical, getRelativeHeight(4.0))
                        .padding(.horizontal, getRelativeWidth(14.0))
                }
                .frame(width: getRelativeWidth(384.0), height: getRelativeHeight(129.0),
                       alignment: .center)
                .background(RoundedCorners(topLeft: 8.0, topRight: 8.0, bottomLeft: 8.0,
                                           bottomRight: 8.0)
                        .fill(ColorConstants.Gray50))
                ...
                VStack {
                    Text(StringConstants.kLblBenefits)
                        ...
                        .padding(.top, getRelativeHeight(16.0))
                        .padding(.horizontal, getRelativeWidth(14.0))
                    Text(StringConstants.kMsgCandidatesWho)
                        .font(FontScheme.kRobotoBlack(size: getRelativeHeight(11.0)))
                        .fontWeight(.black)
                        .foregroundColor(ColorConstants.Bluegray400)
                        .minimumScaleFactor(0.5)
                        .multilineTextAlignment(.leading)
                        .frame(width: getRelativeWidth(348.0), height: getRelativeHeight(26.0),
                               alignment: .topLeading)
                        .padding(.vertical, getRelativeHeight(11.0))
                        .padding(.horizontal, getRelativeWidth(14.0))
                }
                .frame(width: getRelativeWidth(384.0), height: getRelativeHeight(80.0),
                       alignment: .center)
                .background(RoundedCorners(topLeft: 8.0, topRight: 8.0, bottomLeft: 8.0,
                                           bottomRight: 8.0)
                        .fill(ColorConstants.Gray50))
                ...
                VStack {
                    Text(StringConstants.kLblPrefer)
                        ...
                        .padding(.horizontal, getRelativeWidth(14.0))
                    Text(StringConstants.kMsgCandidatesAble)
                        .font(FontScheme.kRobotoBlack(size: getRelativeHeight(11.0)))
                        .fontWeight(.black)
                        .foregroundColor(ColorConstants.Bluegray400)
                        .minimumScaleFactor(0.5)
                ...
                .frame(width: getRelativeWidth(384.0), height: getRelativeHeight(96.0),
                       alignment: .center)
                .background(RoundedCorners(topLeft: 8.0, topRight: 8.0, bottomLeft: 8.0,
                                           bottomRight: 8.0)
                        .fill(ColorConstants.Gray50))
...
struct CompanyApply1View_Previews: PreviewProvider {
