...
struct CompanySavedProfileOneView: View {
    @StateObject var companySavedProfileOneViewModel = CompanySavedProfileOneViewModel()
            ...
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    ZStack(alignment: .topLeading) {
                        ...
                        VStack {
                            ...
                            Text(StringConstants.kMsgDigitalPenang2)
                    ...
                    ZStack(alignment: .leading) {
                        HStack {
                            Image("img_ellipse3")
                                ...
                                .clipShape(Circle())
                                .onTapGesture {
                                    companySavedProfileOneViewModel
                        ...
                        ZStack(alignment: .topTrailing) {
                            ...
                            VStack(alignment: .leading, spacing: 0) {
                                VStack {
                                    Text(StringConstants.kLbl58kSaves)
                                        .font(FontScheme
                                    ...
                                    Divider()
                                        ...
                                        .padding(.horizontal, getRelativeWidth(28.0))
                                    Text(StringConstants.kLbl20kFollowers)
                                        .font(FontScheme
                                            .kRobotoRomanBold(size: getRelativeHeight(18.0)))
                                        .fontWeight(.bold)
                                        .foregroundColor(ColorConstants.Black900)
                ...
                Group {
                    NavigationLink(destination: VHackHomeCompaPageOneView(),
                                   ...
                                   selection: $companySavedProfileOneViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
...
struct CompanySavedProfileOneView_Previews: PreviewProvider {
    static var previews: some View {
        CompanySavedProfileOneView()
    }
}
